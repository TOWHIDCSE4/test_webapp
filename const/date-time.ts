...
export const DAY_BETWEEN_CIRCLE = 15

export const DATE_FORMAT = 'DD-MM-YYYY'

export const TIME_RANGE = Array(32).fill(0) // Mangr khoang thoi gian tu 7h -> 22h30phut, cach nhau 30 phut
...
export const MAX_HOURS_EDIT_MEMO = 48
...
export const MAX_TIME_SHOWN_REMAIN = 15 // remain less 15 days shown
